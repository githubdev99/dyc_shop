                ...
                <div class="col-lg-6">
                    <section class="widget widget-light-skin">
                        ...
                        <center>
                            ...
                            <a class="social-button shape-circle sb-twitter sb-light-skin" href="https://www.twitter.com" target="_blank">
                                <i class="socicon-twitter"></i>
                            </a>
                            <a class="social-button shape-circle sb-instagram sb-light-skin" href="https://www.instagram.com" target="_blank">
