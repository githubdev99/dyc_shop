<header id="page-topbar" style="background: linear-gradient(to right, #00b4db, #0083b0);">
	<div class="navbar-header">
		...
		<div class="d-flex">
			...
			<div data-simplebar style="max-height: 230px;">
				...
				<a href="#" class="text-reset notification-item">
					<div class="media">
						<img src="<?= base_url() ?>assets/images/avatar_male.png" class="mr-3 rounded-circle avatar-xs" alt="user-pic">
						<div class="media-body">
	...
	<div class="dropdown d-inline-block">
		...
		<span class="d-none d-xl-inline-block ml-1">Devan</span>
	...
	<div class="dropdown-menu dropdown-menu-right">
		...
		<a class="dropdown-item text-danger" href="<?= base_url() ?>admin/login"><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i> Logout</a>
	</div>
</div>
