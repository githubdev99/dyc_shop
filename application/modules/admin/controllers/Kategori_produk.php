	...
	public function index()
	{
        ...
        if (!$this->input->post()) {
            ...
            $check_data = $this->master_model->select_data([
                ...
                'where' => [
                    'LOWER(nama_kategori)' => trim(strtolower($this->input->post('nama_kategori')))
                ]
            ])->result();
    ...
    public function detail($id)
    {
        ...
        if (!$this->input->post()) {
            ...
            $check_data = $this->master_model->select_data([
                ...
                'where' => [
                    'LOWER(nama_sub_kategori)' => trim(strtolower($this->input->post('nama_sub_kategori')))
                ]
            ])->result();

            $check_data2 = $this->master_model->select_data([
                'field' => 'nama_kategori',
                'table' => 'produk_kategori',
                'where' => [
                    'LOWER(nama_kategori)' => trim(strtolower($this->input->post('nama_kategori')))
